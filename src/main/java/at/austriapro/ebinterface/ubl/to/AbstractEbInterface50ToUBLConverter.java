...
public abstract class AbstractEbInterface50ToUBLConverter extends AbstractEbInterfaceToUBLConverter
{
   ...
   */
  public AbstractEbInterface50ToUBLConverter (@Nonnull final Locale aDisplayLocale, @Nonnull final Locale aContentLocale)
  {
    super (aDisplayLocale, aContentLocale);
  }

  @Nullable
  protected static <T extends CodeType> T getTypeCode (@Nullable final Ebi50DocumentTypeType eType, @Nonnull final Supplier <T> aFactory)
  {
    String sID = null;
    if (eType != null)
      switch (eType)
  ...
  @Nullable
  protected static AddressType convertAddress (@Nullable final Ebi50AddressType aEbiAddress, @Nonnull final Locale aContentLocale)
  {
    if (aEbiAddress == null)
      return null;
  ...
  @Nullable
  protected static DeliveryType convertDelivery (@Nullable final Ebi50DeliveryType aEbiDelivery, @Nonnull final Locale aContentLocale)
  {
