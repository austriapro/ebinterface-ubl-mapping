 ...
 */
public interface ICustomInvoiceToEbInterface61Converter
{
  /**
   ...
   *        <code>null</code>.
   */
  default void additionalItemMapping (@Nonnull final InvoiceLineType aUBLInvoiceLine, @Nonnull final Ebi61ListLineItemType aEbiInvoiceLine)
  {}
   ...
   */
  default void additionalGlobalMapping (@Nonnull final InvoiceType aUBLInvoice, @Nonnull final Ebi61InvoiceType aEbiInvoice)
  {}
}
