 ...
 */
public interface ICustomCreditNoteToEbInterface61Converter
{
  /**
  ...
  default void additionalItemMapping (@Nonnull final CreditNoteLineType aUBLCreditNoteLine,
                                      @Nonnull final Ebi61ListLineItemType aEbiInvoiceLine)
  {}
   ...
   */
  default void additionalGlobalMapping (@Nonnull final CreditNoteType aUBLCreditNote, @Nonnull final Ebi61InvoiceType aEbiInvoice)
  {}
}
