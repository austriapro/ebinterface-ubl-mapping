 ...
 */
@Immutable
public final class InvoiceToEbInterface41Converter extends AbstractToEbInterface41Converter
{
   ...
   */
  @Nullable
  public Ebi41InvoiceType convertToEbInterface (@Nonnull final InvoiceType aUBLDoc, @Nonnull final ErrorList aTransformationErrorList)
  {
    ...
    aEbiDoc.setDocumentType (getAsDocumentTypeType (aUBLDoc.getInvoiceTypeCode () == null ? null : aUBLDoc.getInvoiceTypeCode ().getName (),
                                                    ...
                                                    Ebi41DocumentTypeType.INVOICE.value ()));
