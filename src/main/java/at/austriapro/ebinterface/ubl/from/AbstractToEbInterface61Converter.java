...
/**
 * Base class for Peppol UBL to ebInterface 6.1 converter
 *
...
{
  protected AbstractToEbInterface61Converter (@Nonnull final Locale aDisplayLocale,
  ...
  public static void setAddressData (@Nullable final AddressType aUBLAddress,
                                     @Nonnull final Ebi61AddressType aEbiAddress,
                                     @Nonnull final Locale aContentLocale)
  {
    ...
    if (aUBLAddress != null)
    {
      ...
      {
        final Ebi61CountryType aEbiCountry = new Ebi61CountryType ();
  ...
  public static void validateContactData (@Nonnull final Ebi61ContactType aEbiContact,
  ...
  @Nullable
  public static Ebi61ContactType convertContact (@Nonnull final PartyType aUBLParty,
                                                 @Nonnull final String sPartyType,
                                                 ...
                                                 final boolean bValidate)
  {
    ...
    final Ebi61ContactType aEbiContact = new Ebi61ContactType ();
  ...
  public static void validateAddressData (@Nonnull final Ebi61AddressType aEbiAddress,
                                          @Nonnull final String sPartyType,
                                          @Nonnull final ErrorList aTransformationErrorList,
                                          @Nonnull final Locale aDisplayLocale)
  {
  ...
  @Nonnull
  public static Ebi61AddressType convertParty (@Nonnull final PartyType aUBLParty,
                                               @Nonnull final String sPartyType,
                                               @Nonnull final ErrorList aTransformationErrorList,
                                               @Nonnull final Locale aContentLocale,
                                               @Nonnull final Locale aDisplayLocale,
                                               final boolean bValidate)
  {
    final Ebi61AddressType aEbiAddress = new Ebi61AddressType ();
    ...
    if (aUBLParty.getEndpointID () != null)
    {
      ...
      if (StringHelper.hasText (sEndpointID))
      {
        ...
        {
          final Ebi61AddressIdentifierType aEbiType = new Ebi61AddressIdentifierType ();
  ...
  @Nonnull
  public static Ebi61DeliveryType convertDelivery (@Nonnull final DeliveryType aUBLDelivery,
                                                   ...
                                                   @Nonnull final Locale aDisplayLocale)
  {
    final Ebi61DeliveryType aEbiDelivery = new Ebi61DeliveryType ();
    ...
    Ebi61AddressType aEbiAddress = null;
    if (aUBLParty != null)
    {
    ...
    if (aEbiAddress == null || isAddressIncomplete (aEbiAddress))
    {
      ...
      {
        if (aEbiAddress == null)
          aEbiAddress = new Ebi61AddressType ();
  ...
  @Nullable
  protected static final Ebi61DocumentTypeType getAsDocumentTypeType (@Nullable final String... aValues)
  {
    if (aValues != null)
      for (final String s : aValues)
        if (s != null)
        {
          ...
          try
          {
            ...
            return Ebi61DocumentTypeType.fromValue (sClean);
          }
                                                 ...
                                                 @Nonnull final Ebi61InvoiceType aEbiDoc)
  {
    for (final BillingReferenceType aUBLBillingReference : aUBLBillingReferences)
    {
          ...
          aUBLBillingReference.getInvoiceDocumentReference ().getIDValue () != null)
      {
        ...
        aEbiRelatedDocument.setDocumentType (Ebi61DocumentTypeType.INVOICE);
            ...
            aUBLBillingReference.getCreditNoteDocumentReference ().getIDValue () != null)
        {
          ...
          aEbiRelatedDocument.setInvoiceDate (aUBLBillingReference.getCreditNoteDocumentReference ()
                                                                  .getIssueDateValue ());
          aEbiRelatedDocument.setDocumentType (Ebi61DocumentTypeType.CREDIT_MEMO);
          aEbiDoc.addRelatedDocument (aEbiRelatedDocument);
        }
      // Ignore other values
    }
  ...
  private static void _setPaymentMeansComment (@Nonnull final PaymentMeansType aUBLPaymentMeans,
                                               @Nonnull final Ebi61PaymentMethodType aEbiPaymentMethod)
  {
  ...
  {
    final Ebi61PaymentMethodType aEbiPaymentMethod = new Ebi61PaymentMethodType ();
    final Ebi61PaymentConditionsType aEbiPaymentConditions = new Ebi61PaymentConditionsType ();
      ...
      for (final PaymentMeansType aUBLPaymentMeans : aUBLDocPaymentMeans.get ())
      {
        ...
        if (isUniversalBankTransaction (sPaymentMeansCode))
        {
          ...
          if (isIBAN (sPaymentChannelCode))
          {
            ...
            final Ebi61UniversalBankTransactionType aEbiUBTMethod = new Ebi61UniversalBankTransactionType ();
            ...
            for (final PaymentIDType aUBLPaymentID : aUBLPaymentMeans.getPaymentID ())
            {
              ...
              if (StringHelper.hasText (sUBLPaymentID))
              {
                ...
                final Ebi61PaymentReferenceType aEbiPaymentReference = new Ebi61PaymentReferenceType ();
            ...
            // Beneficiary account
            final Ebi61AccountType aEbiAccount = new Ebi61AccountType ();
          ...
          if (isSEPADirectDebit (sPaymentMeansCode))
          {
            ...
            // use SEPA fields
            final Ebi61SEPADirectDebitType aEbiDirectDebit = new Ebi61SEPADirectDebitType ();
            aEbiDirectDebit.setType (Ebi61SEPADirectDebitTypeType.B_2_B);
          ...
          else
          {
            ...
            if (MathHelper.isEQ0 (aEbiDoc.getPayableAmount ()))
            {
              ...
              _setPaymentMeansComment (aUBLPaymentMeans, aEbiPaymentMethod);
              final Ebi61NoPaymentType aEbiNoPayment = new Ebi61NoPaymentType ();
      ...
      for (final PaymentTermsType aUBLPaymentTerms : aUBLDocPaymentTerms.get ())
      {
        ...
        if (aUBLPaymentTerms.getPaymentDueDate () != null)
        {
          ...
          if (aUBLPaymentTerms.getSettlementDiscountPercent () != null)
          {
            ...
            {
              final Ebi61DiscountType aEbiDiscount = new Ebi61DiscountType ();
  ...
  @Nonnull
  protected static Ebi61FurtherIdentificationType createFurtherIdentification (@Nonnull final String sKey,
  ...
  protected static void convertFurtherIdentifications (@Nonnull final List <PartyIdentificationType> aPartyIDs,
                                                       @Nonnull final Consumer <? super Ebi61FurtherIdentificationType> aFIConsumer)
  {
