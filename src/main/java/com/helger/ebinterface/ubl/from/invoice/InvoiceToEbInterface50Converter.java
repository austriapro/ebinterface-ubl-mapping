...
import com.helger.ebinterface.ubl.from.AbstractToEbInterface50Converter;
import com.helger.ebinterface.ubl.from.EbInterface50Helper;
...
/**
 * Main converter between UBL 2.1 invoice and ebInterface 5.0 invoice.
 *
...
public final class InvoiceToEbInterface50Converter extends AbstractToEbInterface50Converter
{
   ...
   */
  public InvoiceToEbInterface50Converter (@Nonnull final Locale aDisplayLocale,
  ...
  @Nonnull
  public InvoiceToEbInterface50Converter setCustomizer (@Nullable final ICustomInvoiceToEbInterface50Converter aCustomizer)
  {
   ...
   */
  @Nullable
  public Ebi50InvoiceType convertToEbInterface (@Nonnull final InvoiceType aUBLDoc,
                                                @Nonnull final ErrorList aTransformationErrorList)
  {
    ...
    aEbiDoc.setDocumentType (getAsDocumentTypeType (aUBLDoc.getInvoiceTypeCode () == null ? null
                                                    ...
                                                    Ebi50DocumentTypeType.INVOICE.value ()));
    ...
    // Biller/Supplier (creator of the invoice)
    {
      ...
      if (aUBLSupplier.getParty () != null)
      {
        aEbiBiller.setAddress (EbInterface50Helper.convertParty (aUBLSupplier.getParty (),
                                                                 "AccountingSupplierParty",
                                                                 aTransformationErrorList,
                                                                 m_aContentLocale,
                                                                 m_aDisplayLocale,
                                                                 true));
        aEbiBiller.setContact (EbInterface50Helper.convertContact (aUBLSupplier.getParty (),
                                                                   "AccountingSupplierParty",
                                                                   aTransformationErrorList,
                                                                   m_aDisplayLocale,
                                                                   true));
    ...
    // Invoice recipient
    {
      ...
      if (aUBLCustomer.getParty () != null)
      {
        aEbiRecipient.setAddress (EbInterface50Helper.convertParty (aUBLCustomer.getParty (),
                                                                    "AccountingCustomerParty",
                                                                    aTransformationErrorList,
                                                                    m_aContentLocale,
                                                                    m_aDisplayLocale,
                                                                    true));
        aEbiRecipient.setContact (EbInterface50Helper.convertContact (aUBLCustomer.getParty (),
                                                                      "AccountingCustomerParty",
                                                                      aTransformationErrorList,
                                                                      m_aDisplayLocale,
                                                                      true));
    ...
    if (aUBLBuyer != null)
    {
      ...
      if (aUBLBuyer.getParty () != null)
      {
        aEbiOrderingParty.setAddress (EbInterface50Helper.convertParty (aUBLBuyer.getParty (),
                                                                        "BuyerCustomerParty",
                                                                        aTransformationErrorList,
                                                                        m_aContentLocale,
                                                                        m_aDisplayLocale,
                                                                        true));
        aEbiOrderingParty.setContact (EbInterface50Helper.convertContact (aUBLBuyer.getParty (),
                                                                          "BuyerCustomerParty",
                                                                          aTransformationErrorList,
                                                                          m_aDisplayLocale,
                                                                          true));
    ...
    BigDecimal aTotalZeroPercLineExtensionAmount = BigDecimal.ZERO;
    {
      ...
      for (final InvoiceLineType aUBLLine : aUBLDoc.getInvoiceLine ())
      {
        ...
        if (aUBLLine.hasDeliveryEntries ())
        {
          ...
          {
            final Ebi50DeliveryType aEbiDelivery = EbInterface50Helper.convertDelivery (aUBLDelivery,
                                                                                        "InvoiceLine[" +
                                                                                                      nLineIndex +
                                                                                                      "]/Delivery[" +
                                                                                                      nDeliveryIndex +
    ...
    Ebi50DeliveryType aEbiDelivery = null;
    {
      ...
      for (final DeliveryType aUBLDelivery : aUBLDoc.getDelivery ())
      {
        ...
        if (aUBLDelivery.getActualDeliveryDate () != null)
        {
          aEbiDelivery = EbInterface50Helper.convertDelivery (aUBLDelivery,
