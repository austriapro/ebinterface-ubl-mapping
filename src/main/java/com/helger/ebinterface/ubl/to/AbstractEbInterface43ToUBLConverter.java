 ...
 */
@Immutable
public abstract class AbstractEbInterface43ToUBLConverter extends AbstractConverter
{
  @Translatable
  ...
  private static final Logger s_aLogger = LoggerFactory.getLogger (AbstractEbInterface43ToUBLConverter.class);
  ...
  protected static AddressType convertAddress (@Nullable final Ebi43AddressType aEbiAddress)
  {
    ...
    for (final Ebi43AddressIdentifierType aEbiType : aEbiAddress.getAddressIdentifier ())
    {
