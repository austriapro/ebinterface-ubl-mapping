...
/**
 * Test class for class {@link CreditNoteToEbInterface61Converter}.
 *
 * @author Philip Helger
 */
public final class CreditNoteToEbInterface61ConverterTest
{
  private static final Logger LOGGER = LoggerFactory.getLogger (CreditNoteToEbInterface61ConverterTest.class);
  ...
  public void testConvertPeppolCreditNoteLax ()
  {
    ...
    for (final IReadableResource aRes : aTestFiles)
    {
      ...
      final Ebi61InvoiceType aEbInvoice = new CreditNoteToEbInterface61Converter (Locale.GERMANY,
                                                                                  Locale.GERMANY,
      ...
      assertTrue (new MockEbi61Marshaller ().write (aEbInvoice, new File (TARGET_FOLDER + FilenameHelper.getWithoutPath (aRes.getPath ())))
                                            .isSuccess ());
    }
  }
