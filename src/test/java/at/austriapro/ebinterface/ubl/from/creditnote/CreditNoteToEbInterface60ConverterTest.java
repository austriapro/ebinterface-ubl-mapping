...
/**
 * Test class for class {@link CreditNoteToEbInterface60Converter}.
 *
 * @author Philip Helger
 */
public final class CreditNoteToEbInterface60ConverterTest
{
  private static final Logger LOGGER = LoggerFactory.getLogger (CreditNoteToEbInterface60ConverterTest.class);
  ...
  public void testConvertPeppolCreditNoteLax ()
  {
    ...
    for (final IReadableResource aRes : aTestFiles)
    {
      ...
      final Ebi60InvoiceType aEbInvoice = new CreditNoteToEbInterface60Converter (Locale.GERMANY,
                                                                                  Locale.GERMANY,
      ...
      assertTrue (new MockEbi60Marshaller ().write (aEbInvoice, new File (TARGET_FOLDER + FilenameHelper.getWithoutPath (aRes.getPath ())))
                                            .isSuccess ());
    }
  }
