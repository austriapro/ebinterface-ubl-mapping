...
import com.helger.ebinterface.ubl.from.Ebi43TestMarshaller;
...
/**
 * Test class for class {@link InvoiceToEbInterface43Converter}.
 *
...
public final class InvoiceToEbInterface43ConverterTest
{
  ...
  public void testConvertPEPPOLInvoiceLax ()
  {
    ...
    for (final IReadableResource aRes : aTestFiles)
    {
      ...
      final Ebi43InvoiceType aEbInvoice = new InvoiceToEbInterface43Converter (Locale.GERMANY,
                                                                               Locale.GERMANY,
  ...
  public void testConvertPEPPOLInvoiceLaxBad ()
  {
    ...
    for (final IReadableResource aRes : aTestFiles)
    {
      ...
      // Convert ebInterface to XML
      final Document aDocEb = new Ebi43TestMarshaller ().getAsDocument (aEbInvoice);
      assertNull (aDocEb);
    }
  }
}
