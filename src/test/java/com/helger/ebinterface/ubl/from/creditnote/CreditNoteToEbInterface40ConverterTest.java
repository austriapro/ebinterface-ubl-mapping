...
import com.helger.ebinterface.ubl.from.MockEbi40Marshaller;
...
/**
 * Test class for class {@link CreditNoteToEbInterface40Converter}.
 *
 * @author Philip Helger
 */
public final class CreditNoteToEbInterface40ConverterTest
{
  private static final Logger LOGGER = LoggerFactory.getLogger (CreditNoteToEbInterface40ConverterTest.class);
  ...
  private static final ICommonsSet <String> IGNORED_FILES = new CommonsHashSet <> ("BII05 TRDM014 example at.xml",
  ...
  public void testConvertPEPPOLCreditNoteLax ()
  {
    ...
    for (final IReadableResource aRes : aTestFiles)
    {
      ...
      final Ebi40InvoiceType aEbInvoice = new CreditNoteToEbInterface40Converter (Locale.GERMANY,
                                                                                  Locale.GERMANY,
